...
public protocol StartupTimeDependency: Dependency { var startupTime: Date { get } }
...
public protocol MessageDependency: Dependency { var messageToCarryThrough: String { get } }
